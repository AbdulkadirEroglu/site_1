...
class Settings(BaseSettings):
    ...
    smtp_host: str  = Field(default=None, env="SMTP_HOST")
    smtp_port: int = Field(default=587, env="SMTP_PORT")
    smtp_username: str = Field(default=None, env="SMTP_USERNAME")
    smtp_password: str = Field(default=None, env="SMTP_PASSWORD")
